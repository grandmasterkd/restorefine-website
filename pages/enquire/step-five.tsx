        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            ...
            <Input
              ...
              className="border-white/80 bg-transparent text-white placeholder:text-white/50"
            />
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              className="min-h-[100px] border-white/80 bg-transparent text-white placeholder:text-white/50"
            />
          ...
          >
            ...
            <div className="flex h-5 w-5 items-center justify-center rounded-full bg-[#ff0000]">
              <ArrowLeft className="h-3 w-3 rotate-180 text-white" />
            </div>
          </button>
        </form>
      </div>
