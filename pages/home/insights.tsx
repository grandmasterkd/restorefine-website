      ...
      <section className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div className="col-span-1 sm:col-span-2 h-[250px] sm:h-[350px]  rounded-[24px] bg-[#131313] grid place-items-center">
          <Image
            ...
            width={350}
            height={350}
            className="w-full h-full px-3 object-contain grayscale-none md:grayscale hover:grayscale-0 transition-all duration-700 ease-in-out"
          />
        </div>
      </section>
      ...
      <section className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
        <div className="col-span-1 sm:col-span-2 h-[250px] sm:h-[350px]  rounded-[24px] bg-[#131313] grid place-items-center">
          <Image
            ...
            width={350}
            height={350}
            className="w-full h-full object-contain p-4 sm:p-6 md:p-10 grayscale-none md:grayscale hover:grayscale-0 transition-all duration-700 ease-in-out"
          />
        </div>
