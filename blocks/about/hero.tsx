        ...
        <div className="space-y-3 lg:space-y-4">
          ...
          <div className="max-w-full text-sm md:text-base text-white/80 space-y-4">
            <p>
              ...
              Scotland&apos;s top all-in-one agency, headquartered in Glasgow
              and serving businesses across the nation. Our vision stems from a
              deep understanding of the challenges faced by businesses and
